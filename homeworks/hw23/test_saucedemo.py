...
2. On the opened page of the shop - https://www.saucedemo.com/inventory.html:
    2.1 Press 'Add to cart' button for 'Sauce Labs Backpack' item -
        selector for 'Add to cart' button: button[id="add-to-cart-sauce-labs-backpack"]
        Verification: Check that the shopping cart badge displays '1' -
            selector: [class=shopping_cart_badge]
    2.2 Press the Cart Icon in the upper right corner -
        ...
        Verification:
            ...
            - Check that the page title text equals 'Your Cart' -
                selector: [class=title]
            - Check that the cart quantity equals '1' -
                selector: [class=cart_quantity]
            - Check that the product name equals 'Sauce Labs Backpack' -
...
4. On the opened page for checkout - https://www.saucedemo.com/checkout-step-one.html:
    4.1 Fill 'First Name' field with the value 'Umpa' -
        selector for 'First Name' field: input[id="first-name"]
        Verification: Check that the 'First Name' field has value 'Umpa' -
            selector: input[id="first-name"]
    4.2 Fill 'Last Name' field with the value 'Lumpa' -
        selector for 'Last Name' field: input[id="last-name"]
        Verification: Check that the 'Last Name' field has value 'Lumpa' -
            selector: input[id="last-name"]
    4.3 Fill 'Zip/Postal Code' field with the value '123456' -
        selector for 'Zip/Postal Code' field: input[id="postal-code"]
        Verification: Check that the 'Zip/Postal Code' field has value '123456' -
